...
def test_set_up_reservations_starts_all_flights_in_proceses(mocker: MockerFixture) -> None:
    config = Config()
...
def test_set_up_check_in_sets_up_account_and_flight_with_arguments(
    ...
    assert len(mock_set_up_reservations.call_args[0][0].flights) == flights_len

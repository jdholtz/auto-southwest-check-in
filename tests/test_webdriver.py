...
def test_get_info_gets_checkin_info_when_no_account_is_provided(mocker: MockerFixture) -> None:
...
def test_get_info_gets_account_info_when_an_account_is_provided(mocker: MockerFixture) -> None:

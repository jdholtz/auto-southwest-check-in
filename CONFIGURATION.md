...
> If you are also using `config.json`, any it will append the credentials as long as they are not a duplicate.
...
> If you are also using `config.json`, any it will append the reservation as long as they are not a duplicate.
